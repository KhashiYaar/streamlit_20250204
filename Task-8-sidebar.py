...
st.write(f"### Histogram of GDP per Capita for All Countries in {selected_year}")
...
fig = px.histogram(
    ...
    x="GDP per capita",
    nbins=50,
    title=f"GDP per Capita Distribution in {selected_year}",
...
fig = px.histogram(
    ...
    nbins=50,
    title=f"Life Expectancy (IHME) Distribution in {selected_year}",
